...
def transcribe_audio(audio):
    ...
    # return (transcription,response) # Return state as the second output
...
with gr.Blocks(css=custom_css) as demo:
    ...
    with gr.Tab("Audio"):
        ...
        process_button.click(
            ...
            # outputs=[transcription_output, response_output], // opsi second output
        )
    ...
    with gr.Tab("Image"):
        ...
        analyze_button.click(
            analyze_image, inputs=image_input, outputs=[image_description_output]
        )
